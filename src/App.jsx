...
function App() {
  ...
  return (
    <div className="h-screen flex items-center justify-center p-10 bg-white flex-col">
      <div className='bg-white border-2 border-gray-100 shadow-xl p-10 rounded-lg text-black'>
        ...
        <div className='flex'>
          <input
            className='border-2 shadow-sm bg-white border-gray-100 text-black rounded-l-md font-bold p-2 text-center'
            type='text'
            value={newTask}
            onChange={handleChange}
          />
          <button
            className='bg-black shadow-sm border-2 border-black font-light font-serif tracking-wider rounded-r-md text-white p-2'
            onClick={addTask}
          >
            Add Todo
          </button>
